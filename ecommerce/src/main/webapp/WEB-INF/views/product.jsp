...
<div class="magnify">
    ...
    <br>
          ...
          <a href="index.jsp"><button type="button" class="btn btn-info btn-md"  >ADD TO CART</button></a><br><br>
         
          <a href="index.jsp"><button type="button" class="btn btn-info btn-md"  >CONTINUE SHOPPING</button></a>
    </div>
  </div>
</div>
</body>
