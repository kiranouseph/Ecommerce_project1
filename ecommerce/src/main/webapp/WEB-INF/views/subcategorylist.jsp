...
<figure class="snip1581"><img src="resources/products/${designate.subcatimage}" alt="profile-sample2" style="width:100%;height:250px"/>
  <figcaption>
    
    <h3 class="title2" style="color:blue;">${designate.subcategoryname }</h3>
